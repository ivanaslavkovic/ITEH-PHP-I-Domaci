...
$posiljke = $posiljka->pretragaPosiljke($connection, $_POST['broj_posiljke']);

if (mysqli_num_rows($posiljke) > 0) {
    $p = $posiljke->fetch_object();
?>
    <tr>
...
<?php
    ...
    echo 'Ne postoji pošiljka sa tim brojem!';
}
